            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-navbar" id="navbarli">
                  ...
                  class="nav-item dropdown-item">Keluar</button></li>
                </ul>
                @else 
                <ul class="dropdown-menu dropdown-navbar" id="navbarli">
                  <li class="nav-link">
                  <button type="button" data-target ="#exampleModal" data-toggle="modal" id="btnsignin" 
                  class="nav-item dropdown-item">Masuk</button></li>
                </ul>
                @endif
              </li>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content bg-dark">
            ...
            <div class="modal-body">
                <form id="addUser" method="POST" action="{{route('signin')}}">
                  @csrf
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-info" name="signin" onclick="btnlogin()" id="quickstart-sign-in">Masuk</button>
              </div>
              </form>  
            </div>
          </div>
