...
@section('content')
<!-- <script src="{{ URL::asset('js/auth1.js') }} "></script> -->
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <input type="number" name="tinggiinp" id="tinggiinp" width="10" disabled class="form-control" min=1 max=200>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <input type="number" name="luasinp" id="luasinp" disabled class="form-control" min=1 max=100>
                                          </td>
                                        </tr>
                                        <!--
                                        <tr>
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <input type="number" disabled name = "stat1inp" id="stat1inp" class="form-control" min=1 max=100>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                          ...
                                          <td>
                                            ...
                                            <input type="number" disabled name = "stat2inp" id="stat2inp" class="form-control" min=1 max=100>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                          ...
                                          <td>
                                            ...
                                            <input type="number" disabled name = "stat2inp" id="stat3inp" class="form-control" min=1 max=100>
                                          </td>
                                        </tr>
    ...
    <script>
      $.ajax({
        ...
        success: function (response) {
          document.getElementById("tinggiinp").setAttribute('value', response.data.tinggi_sensor);
          document.getElementById("luasinp").setAttribute('value', response.data.luas_area);
          document.getElementById("stat1inp").setAttribute('value', response.data.stat1);
          document.getElementById("stat2inp").setAttribute('value', response.data.stat2);
          document.getElementById("stat3inp").setAttribute('value', response.data.stat3);
        }
      });
      ...
      function opensetting(){
        ...
        document.getElementById("luasinp").removeAttribute("disabled");
      ...
      function canceledit(){
          ...
          document.getElementById("luasinp").setAttribute("disabled", "true");
      ...
      function updateUser() { 
        //location.replace("{{route('updateset')}}")

        $.ajax({
          type: "POST",
          url: "{{route('updateset')}}",
          data: {
            tinggiinp : $('#tinggiinp').val(),
            luasinp : $('#luasinp').val(),
            stat1inp : $('#stat1inp').val(),
            stat2inp : $('#stat2inp').val(),
            stat3inp : $('#stat3inp').val(),
          },
